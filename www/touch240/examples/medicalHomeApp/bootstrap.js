...
Ext.Loader.addClassPathMappings({
  ...
  "MedicalHome": "app",
  "MedicalHome.util.Proxy": "app/store/Speakers.js"
});
Ext.ClassManager.addNameAlternateMappings({
  ...
  "MedicalHome.controller.Main": [],
  "MedicalHome.controller.phone.Main": [],
  "MedicalHome.controller.tablet.Main": [],
  "MedicalHome.controller.windowsphone.Main": [],
  "MedicalHome.model.Cars": [],
  "MedicalHome.model.Contact": [],
  "MedicalHome.model.Demo": [],
  "MedicalHome.model.OHLC": [],
  "MedicalHome.model.Order": [],
  "MedicalHome.model.OrderItem": [],
  "MedicalHome.model.Speaker": [],
  "MedicalHome.model.User": [],
  "MedicalHome.profile.Base": [],
  "MedicalHome.profile.Phone": [],
  "MedicalHome.profile.Tablet": [],
  "MedicalHome.store.Demos": [],
  "MedicalHome.store.List": [],
  "MedicalHome.store.OrderItems": [],
  "MedicalHome.store.Pie": [],
  "MedicalHome.store.Speakers": [],
  "MedicalHome.store.StockPrice": [],
  "MedicalHome.store.USD2EUR": [],
  "MedicalHome.util.Proxy": [],
  "MedicalHome.view.Ajax": [],
  "MedicalHome.view.AreaChart": [],
  "MedicalHome.view.Audio": [],
  "MedicalHome.view.BarChart": [],
  "MedicalHome.view.BasicDataView": [],
  "MedicalHome.view.BasicList": [],
  "MedicalHome.view.BottomTabs": [],
  "MedicalHome.view.BubbleChart": [],
  "MedicalHome.view.Buttons": [],
  "MedicalHome.view.CandlestickChart": [],
  "MedicalHome.view.Carousel": [],
  "MedicalHome.view.ColorPatterns": [],
  "MedicalHome.view.ColumnChart": [],
  "MedicalHome.view.ColumnChart3D": [],
  "MedicalHome.view.ColumnChartStacked": [],
  "MedicalHome.view.ColumnChartWithRenderer": [],
  "MedicalHome.view.ColumnSeries3D": [],
  "MedicalHome.view.CoverDown": [],
  "MedicalHome.view.CoverLeft": [],
  "MedicalHome.view.CoverRight": [],
  "MedicalHome.view.CoverUp": [],
  "MedicalHome.view.Cube": [],
  "MedicalHome.view.DisclosureList": [],
  "MedicalHome.view.EditorPanel": [],
  "MedicalHome.view.Fade": [],
  "MedicalHome.view.Flip": [],
  "MedicalHome.view.FormPanel": [],
  "MedicalHome.view.FreeDraw": [],
  "MedicalHome.view.FreeDrawComponent": [],
  "MedicalHome.view.GalleryPage": [],
  "MedicalHome.view.GaugeChart": [],
  "MedicalHome.view.GroupedList": [],
  "MedicalHome.view.HorizontalDataView": [],
  "MedicalHome.view.Icons": [],
  "MedicalHome.view.InlineDataView": [],
  "MedicalHome.view.JSONP": [],
  "MedicalHome.view.LineChart": [],
  "MedicalHome.view.LineChartWithMarker": [],
  "MedicalHome.view.LineChartWithRenderer": [],
  "MedicalHome.view.LoremIpsum": [],
  "MedicalHome.view.LoremIpsum2": [],
  "MedicalHome.view.Map": [],
  "MedicalHome.view.Menus": [],
  "MedicalHome.view.NestedList": [],
  "MedicalHome.view.NestedLoading": [],
  "MedicalHome.view.OHLCChart": [],
  "MedicalHome.view.Overlays": [],
  "MedicalHome.view.PieChart": [],
  "MedicalHome.view.PieChart3D": [],
  "MedicalHome.view.PlotChart": [],
  "MedicalHome.view.Pop": [],
  "MedicalHome.view.RadarChart": [],
  "MedicalHome.view.RevealDown": [],
  "MedicalHome.view.RevealLeft": [],
  "MedicalHome.view.RevealRight": [],
  "MedicalHome.view.RevealUp": [],
  "MedicalHome.view.ScatterChart": [],
  "MedicalHome.view.SlideDown": [],
  "MedicalHome.view.SlideLeft": [],
  "MedicalHome.view.SlideRight": [],
  "MedicalHome.view.SlideUp": [],
  "MedicalHome.view.Sliders": [],
  "MedicalHome.view.SourceOverlay": [],
  "MedicalHome.view.Tabs": [],
  "MedicalHome.view.ThemeAuto": [],
  "MedicalHome.view.ThemeBB": [],
  "MedicalHome.view.ThemeCupertino": [],
  "MedicalHome.view.ThemeCupertinoClassic": [],
  "MedicalHome.view.ThemeMountainView": [],
  "MedicalHome.view.ThemeSencha": [],
  "MedicalHome.view.ThemeTizen": [],
  "MedicalHome.view.ThemeWindows": [],
  "MedicalHome.view.ToolbarInput": [],
  "MedicalHome.view.Toolbars": []
});
Ext.ClassManager.addNameAliasMappings({
  ...
  "MedicalHome.view.ToolbarInput": [],
  "MedicalHome.view.Toolbars": [],
  "MedicalHome.view.VectorIcons": [
    "widget.vicon"
  ],
  "MedicalHome.view.Video": [],
  "MedicalHome.view.XRay": [
    "sprite.xray"
  ],
  "MedicalHome.view.YQL": [],
  "MedicalHome.view.phone.Main": [],
  "MedicalHome.view.sprite.Column3D": [
    "sprite.columnSeries3d"
  ],
  "MedicalHome.view.tablet.Main": [
    "widget.mainview"
  ],
  "MedicalHome.view.tablet.NavigationBar": [
    "widget.tabletnavigationbar"
  ],
  "MedicalHome.view.tablet.NestedList": [
    "widget.tabletnestedlist"
  ],
  "MedicalHome.view.tablet.TouchEvents": [],
  "MedicalHome.view.touchevent.Info": [
    "widget.toucheventinfo"
  ],
  "MedicalHome.view.touchevent.Logger": [
    "widget.toucheventlogger"
  ],
  "MedicalHome.view.touchevent.Pad": [
